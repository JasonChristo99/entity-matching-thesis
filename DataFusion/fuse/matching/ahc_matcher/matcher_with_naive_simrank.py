...
class AgglomerativeHierarchicalClusteringWithNaiveSimrank(MatchingStrategy):
    ...
    def train(self, **kwargs):
        ...
        if self.attr == 'Working Experience':
            self.attribute_to_simrank_matcher['title'] = SimRankNaiveClustering(self.dataset, self.attr, 'title')
        if self.attr == 'Education':
            self.attribute_to_simrank_matcher['degree'] = SimRankNaiveClustering(self.dataset, self.attr, 'degree')
            self.attribute_to_simrank_matcher['university'] = SimRankNaiveClustering(self.dataset, self.attr, 'university')
